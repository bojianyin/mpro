...
class FloatLabelTextField extends Component {
    ...
    rightPadding(){
        return { width: this.props.rightPadding || 0 }
    }
                ...
                <View style={styles.viewContainer}>
                    ...
                    <View style={[styles.fieldContainer, this.withBorder()]}>
                        <FloatingLabel visible={this.state.text}>
                            <Text style={[this.labelStyle(),this.props.sty]}>{this.placeholderValue()}</Text>
                        </FloatingLabel>
                    ...
                    <View style={[styles.paddingView, this.rightPadding()]} />
